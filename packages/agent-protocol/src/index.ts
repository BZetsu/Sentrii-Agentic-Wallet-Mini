...
export type AgentDocumentationTrustSource =
  | 'user_provided'
  | 'same_origin_official'
  | 'official_allowlist'
  | 'research_discovered_unverified';

export type AgentDocumentationTrustLevel =
  | 'high'
  | 'medium'
  | 'low';

export type AgentDocumentationSourceType =
  | 'search_result'
  | 'fetched_document'
  | 'cached_document';
...
export type AgentControlServerMessage =
  | AgentControlSessionReadyEvent
  | AgentControlExecutionRequest
  | AgentControlNotificationEvent;

export type AgentControlClientMessage =
  | AgentControlSessionHelloMessage
  | AgentControlHeartbeatMessage
  | AgentControlExecutionResult;
